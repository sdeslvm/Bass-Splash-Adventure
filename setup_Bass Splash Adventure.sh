...
# Параметры
BUNDLE_ID="com.bassadvent.poqt"
APPLE_ID="6749569754"
REMOTE_URL="git@github.com:sdeslvm/Bass-Splash-Adventure.git"
PROJECT_NAME="Bass Splash Adventure"
SCHEME_NAME="Bass Splash Adventure"
