...
enum BassSplashWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: BassSplashWebStatus) -> Bool {
        switch (self, other) {
...
extension BassSplashWebStatus {
    static func == (lhs: BassSplashWebStatus, rhs: BassSplashWebStatus) -> Bool {
